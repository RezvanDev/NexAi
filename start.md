...
- **Провайдер**: [Hetzner](https://www.hetzner.com/) (лучшее соотношение цена/качество в Европе) или [DigitalOcean](https://www.digitalocean.com/).
...
1. **Загрузи файлы**: Используй `git clone` (если проект в репозитории) или скопируй папку проекта через SCP/SFTP.

2. **Настрой .env**: Создай файл `.env` в папке проекта на сервере:
...
2. **Настрой конфигурацию Nginx**: Создай файл конфига (замени `your-domain.com` на свой домен):
...
3. **Активируй конфиг и получи SSL**:
